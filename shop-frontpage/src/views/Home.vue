          ...
          <div class="row">
            <div class="col col-xs-12">
              <div class="content-area">
                ...
                <a href="shop.html" class="theme-btn-s2">트랜딩</a>
              </div>
            </div>
          </div>
        </div>
                ...
                <ul class="products product-row-slider">
                  <li class="product">
                    <div class="product-holder">
                      ...
                      <a href="shop-single.html"><img loading=lazy src="images/shop/img-7.jpg" alt></a>
                    ...
                    <div class="quick-view-single-product">
                      <div class="view-single-product-inner clearfix">
                        ...
                        <div class="img-holder">
                          <img loading=lazy src="images/shop/img-7.jpg" alt>
                        </div>
                  ...
                  <li class="product">
                    <div class="product-holder">
                      <a href="shop-single.html"><img loading=lazy src="images/shop/img-8.jpg" alt></a>
                      <div class="shop-action-wrap">
                        <ul class="shop-action">
                          <li><a href="#" title="Quick view!"><i class="fi flaticon-view"></i></a>
                          </li>
                    ...
                    <div class="quick-view-single-product">
                      <div class="view-single-product-inner clearfix">
                        <button class="btn quick-view-single-product-close-btn"><i
                            class="pe-7s-close-circle"></i></button>
                        <div class="img-holder">
                          <img loading=lazy src="images/shop/img-8.jpg" alt>
                        </div>
                        <div class="product-details">
                  ...
                  <li class="product">
                    <div class="product-holder">
                      <a href="shop-single.html"><img loading=lazy src="images/shop/img-9.jpg" alt></a>
                      <div class="shop-action-wrap">
                        <ul class="shop-action">
                          <li><a href="#" title="Quick view!"><i class="fi flaticon-view"></i></a>
                          </li>
                    ...
                    <div class="quick-view-single-product">
                      <div class="view-single-product-inner clearfix">
                        <button class="btn quick-view-single-product-close-btn"><i
                            class="pe-7s-close-circle"></i></button>
                        <div class="img-holder">
                          <img loading=lazy src="images/shop/img-9.jpg" alt>
                        </div>
                        <div class="product-details">
                  ...
                  <li class="product">
                    <div class="product-holder">
                      <a href="shop-single.html"><img loading=lazy src="images/shop/img-10.jpg" alt></a>
                      <div class="shop-action-wrap">
                        <ul class="shop-action">
                          <li><a href="#" title="Quick view!"><i class="fi flaticon-view"></i></a>
                          </li>
                    ...
                    <div class="quick-view-single-product">
                      <div class="view-single-product-inner clearfix">
                        <button class="btn quick-view-single-product-close-btn"><i
                            class="pe-7s-close-circle"></i></button>
                        <div class="img-holder">
                          <img loading=lazy src="images/shop/img-10.jpg" alt>
                        </div>
                        <div class="product-details">
                          <h4>Elegant tops</h4>
                          <div class="price">
                  ...
                  <li class="product">
                    <div class="product-holder">
                      <a href="shop-single.html"><img loading=lazy src="images/shop/img-11.jpg" alt></a>
                      <div class="shop-action-wrap">
                        <ul class="shop-action">
                          <li><a href="#" title="Quick view!"><i class="fi flaticon-view"></i></a>
                          </li>
                    ...
                    <div class="quick-view-single-product">
                      <div class="view-single-product-inner clearfix">
                        <button class="btn quick-view-single-product-close-btn"><i
                            class="pe-7s-close-circle"></i></button>
                        <div class="img-holder">
                          <img loading=lazy src="images/shop/img-11.jpg" alt>
                        </div>
                        <div class="product-details">
                  ...
                  <li class="product">
                    <div class="product-holder">
                      <a href="shop-single.html"><img loading=lazy src="images/shop/img-12.jpg" alt></a>
                      <div class="shop-action-wrap">
                        <ul class="shop-action">
                          <li><a href="#" title="Quick view!"><i class="fi flaticon-view"></i></a>
                          </li>
                    ...
                    <div class="quick-view-single-product">
                      <div class="view-single-product-inner clearfix">
                        <button class="btn quick-view-single-product-close-btn"><i
                            class="pe-7s-close-circle"></i></button>
                        <div class="img-holder">
                          <img loading=lazy src="images/shop/img-12.jpg" alt>
                        </div>
                        <div class="product-details">
                          <h4>Two Colure Hoodie</h4>
                          <div class="price">
            ...
            <div class="col col-xs-12">
              <div class="instagram-inner">
                ...
                <div class="instagram-grids clearfix">
                  <div class="grid">
                    <a href="shop-single.html"><img loading=lazy src="images/instagram/1.jpg" alt></a>
                  </div>
                  <div class="grid">
                    <a href="shop-single.html"><img loading=lazy src="images/instagram/3.jpg" alt></a>
                  </div>
                  <div class="grid">
                    <a href="shop-single.html"><img loading=lazy src="images/instagram/4.jpg" alt></a>
                  </div>
                  <div class="grid">
                    <a href="shop-single.html"><img loading=lazy src="images/instagram/2.jpg" alt></a>
                  </div>
                  <div class="grid">
                    <a href="shop-single.html"><img loading=lazy src="images/instagram/5.jpg" alt></a>
                  </div>
                  <div class="grid">
                    <a href="shop-single.html"><img loading=lazy src="images/instagram/6.jpg" alt></a>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section class="newsletter-popup-area-section">
        <div class="newsletter-popup-area">
          <div class="newsletter-popup-ineer">
            ...
            <div class="img-holder">
              <img src="images/newsletter.jpg" loading=lazy alt>
            </div>
            <div class="details">
