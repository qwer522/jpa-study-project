            ...
            <ul class="products product-row-slider">
              <li class="product">
                <div class="product-holder">
                  ...
                  <a href="shop-single.html"><img loading=lazy src="images/shop/img-1.jpg" alt></a>
                ...
                <div class="quick-view-single-product">
                  <div class="view-single-product-inner clearfix">
                    ...
                    <div class="img-holder">
                      <img loading=lazy src="images/shop/img-1.jpg" alt>
                    </div>
              ...
              <li class="product">
                <div class="product-holder">
                  <a href="shop-single.html"><img loading=lazy src="images/shop/img-2.jpg" alt></a>
                  <div class="shop-action-wrap">
                    <ul class="shop-action">
                      <li><a href="#" title="Quick view!"><i class="fi flaticon-view"></i></a>
                      </li>
                ...
                <div class="quick-view-single-product">
                  <div class="view-single-product-inner clearfix">
                    <button class="btn quick-view-single-product-close-btn"><i
                        class="pe-7s-close-circle"></i></button>
                    <div class="img-holder">
                      <img loading=lazy src="images/shop/img-2.jpg" alt>
                    </div>
                    <div class="product-details">
              ...
              <li class="product">
                <div class="product-holder">
                  <a href="shop-single.html"><img loading=lazy src="images/shop/img-3.jpg" alt></a>
                  <div class="shop-action-wrap">
                    <ul class="shop-action">
                      <li><a href="#" title="Quick view!"><i class="fi flaticon-view"></i></a>
                      </li>
                ...
                <div class="quick-view-single-product">
                  <div class="view-single-product-inner clearfix">
                    <button class="btn quick-view-single-product-close-btn"><i
                        class="pe-7s-close-circle"></i></button>
                    <div class="img-holder">
                      <img loading=lazy src="images/shop/img-3.jpg" alt>
                    </div>
                    <div class="product-details">
                      <h4>Short Sleeve</h4>
                      <div class="price">
              ...
              <li class="product">
                <div class="product-holder">
                  <a href="shop-single.html"><img loading=lazy src="images/shop/img-4.jpg" alt></a>
                  <div class="shop-action-wrap">
                    <ul class="shop-action">
                      <li><a href="#" title="Quick view!"><i class="fi flaticon-view"></i></a>
                      </li>
                ...
                <div class="quick-view-single-product">
                  <div class="view-single-product-inner clearfix">
                    <button class="btn quick-view-single-product-close-btn"><i
                        class="pe-7s-close-circle"></i></button>
                    <div class="img-holder">
                      <img loading=lazy src="images/shop/img-4.jpg" alt>
                    </div>
                    <div class="product-details">
                      <h4>Stylish coat</h4>
                      <div class="price">
              ...
              <li class="product">
                <div class="product-holder">
                  <a href="shop-single.html"><img loading=lazy src="images/shop/img-5.jpg" alt></a>
                  <div class="shop-action-wrap">
                    <ul class="shop-action">
                      <li><a href="#" title="Quick view!"><i class="fi flaticon-view"></i></a>
                      </li>
                ...
                <div class="quick-view-single-product">
                  <div class="view-single-product-inner clearfix">
                    <button class="btn quick-view-single-product-close-btn"><i
                        class="pe-7s-close-circle"></i></button>
                    <div class="img-holder">
                      <img loading=lazy src="images/shop/img-5.jpg" alt>
                    </div>
                    <div class="product-details">
              ...
              <li class="product">
                <div class="product-holder">
                  <a href="shop-single.html"><img loading=lazy src="images/shop/img-6.jpg" alt></a>
                  <div class="shop-action-wrap">
                    <ul class="shop-action">
                      <li><a href="#" title="Quick view!"><i class="fi flaticon-view"></i></a>
                      </li>
                ...
                <div class="quick-view-single-product">
                  <div class="view-single-product-inner clearfix">
                    <button class="btn quick-view-single-product-close-btn"><i
                        class="pe-7s-close-circle"></i></button>
                    <div class="img-holder">
                      <img loading=lazy src="images/shop/img-6.jpg" alt>
                    </div>
                    <div class="product-details">
                      <h4>Two Colure Hoodie</h4>
                      <div class="price">
